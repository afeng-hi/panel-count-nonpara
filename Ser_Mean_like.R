...
library(survival);
library(splines2);
group=2;case=1;LAMBDA=LAMBDA1;n=200;tau=10;Obs=6;INN1=4;INN2=4;nknots1=round(2*n^(1/5));nknots2=round(n^(1/5));num.sim=4;num.bots=100;
